...
@section('content')
    ...
    <form action="{{ route('registerPost') }}" class="login100-form validate-form" method="POST">
        @csrf
        ...
        <div class="wrap-input100 validate-input m-b-23" data-validate="Username is reauired">
            ...
            <input class="input100" type="text" name="name" value="{{ old('name') }}" placeholder="Type your username">
