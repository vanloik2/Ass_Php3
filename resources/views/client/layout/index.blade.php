...
<body>
                                                ...
                                                <div class="menu-banner">
                                                    <a href="#" class="menu-banner-link">
                                                        <img class="menu-banner-img"
                                                            src="{{ asset('client/images/banner/menu-banner.jpg') }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                            </div>
    ...
    <div id="mobile-menu-offcanvas" class="offcanvas offcanvas-rightside offcanvas-mobile-menu-section">
        ...
        <div class="offcanvas-mobile-menu-wrapper">
            ...
            <div class="mobile-contact-info">
                <div class="logo">
                    <a href="index.html"><img src="{{ asset('client/images/logo/logo_white.png') }}"
                            alt=""></a>
                </div>
    ...
    <div id="offcanvas-about" class="offcanvas offcanvas-rightside offcanvas-mobile-about-section">
        ...
        <div class="mobile-contact-info">
            <div class="logo">
                <a href="index.html"><img src="{{ asset('client/images/logo/logo_white.png') }}" alt=""></a>
            </div>

            <address class="address">
                <span>Address: 25/106 Đường Phú Minh, Minh Khai, Bắc Từ Liêm, Hà Nội</span>
                <span>Call Us: (+84) 837810180, (+84) 123 456789</span>
                <span>Email: loinvph17567@fpt.edu.vn</span>
            </address>
    ...
    <footer class="footer-section footer-bg" style="margin-top: 100px">
                    ...
                    <div
                        ...
                        <div class="col-auto mb-6">
                            <div class="footer-payment">
                                <div class="image">
                                    <img src="{{ asset('client') }}/company-logo/payment.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="modal-add-cart-product-img">
                                            <img class="img-fluid"
                                                src="{{ asset('client') }}/product/default/home-1/default-1.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                ...
                                <div class="product-details-gallery-area mb-7">
                                    ...
                                    <div
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="product-image-thumb-single swiper-slide">
                                                <img class="img-fluid"
                                                    src="{{ asset('client') }}/product/default/home-1/default-2.jpg"
                                                    alt="">
                                            </div>
                                            <div class="product-image-thumb-single swiper-slide">
                                                <img class="img-fluid"
                                                    src="{{ asset('client') }}/product/default/home-1/default-3.jpg"
                                                    alt="">
                                            </div>
                                            <div class="product-image-thumb-single swiper-slide">
                                                <img class="img-fluid"
                                                    src="{{ asset('client') }}/product/default/home-1/default-4.jpg"
                                                    alt="">
                                            </div>
                                            <div class="product-image-thumb-single swiper-slide">
                                                <img class="img-fluid"
                                                    src="{{ asset('client') }}/product/default/home-1/default-5.jpg"
                                                    alt="">
                                            </div>
                                            <div class="product-image-thumb-single swiper-slide">
                                                <img class="img-fluid"
                                                    src="{{ asset('client') }}/product/default/home-1/default-6.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                        <!-- Add Arrows -->
